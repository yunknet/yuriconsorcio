    ...
    <div className="min-h-screen bg-background font-sans text-foreground selection:bg-accent/30 overflow-x-hidden">
      ...
      <footer className="bg-[#1a2332] text-slate-300 py-16 border-t border-white/5">
        <div className="container mx-auto px-6">
          ...
          {/* Bottom Bar / Legal */}
          <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between text-[13px] text-slate-500 gap-8 text-center md:text-left max-w-6xl mx-auto">
            <div className="flex flex-col gap-1">
              <p>© {new Date().getFullYear()} Yuri Soares Consórcios. Todos os direitos reservados.</p>
              <p className="text-slate-600">CNPJ: 65.474.055/0001-89</p>
            </div>
            
            <div className="flex flex-col md:items-end gap-2 group">
              <div className="flex flex-wrap items-center justify-center md:justify-end gap-x-4 gap-y-2">
                <span className="text-slate-500 italic">Site desenvolvido por <strong className="text-slate-400 not-italic">Aureliano Soares</strong></span>
                <div className="flex items-center gap-4 text-slate-400 md:border-l md:border-white/10 md:pl-4">
